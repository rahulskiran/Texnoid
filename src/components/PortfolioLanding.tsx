        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 sm:h-20 flex items-center justify-between">
          <div className="flex items-center gap-2 sm:gap-3">
            <div className="h-8 w-auto sm:h-10 overflow-hidden flex items-center">
                ...
                />
                <div className="hidden h-8 w-8 sm:h-10 sm:w-10 bg-red-600 rounded-xl items-center justify-center">
          ...
          <div className="hidden lg:flex items-center gap-8">
            {['Services', 'Portfolio', 'Shopify Care', 'Trainings', 'Contact'].map(link => (
            ...
            <button className="bg-slate-900 text-white px-6 py-2.5 rounded-full text-sm font-bold hover:bg-red-600 transition-all">
              Start Building
            </button>
          </div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="flex-1 text-center lg:text-left">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-red-50 border border-red-100 mb-8">
                ...
                <span className="text-xs font-black uppercase tracking-wider text-red-700">Digital Execution Powerhouse</span>
              </div>
